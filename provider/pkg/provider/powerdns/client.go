 ...
 * permission notice:
 *
 *   Copyright 2016 https://github.com/pan-net/terraform-provider-powerdns
 *
 *   License, v. 2.0. If a copy of the MPL was not distributed with this
 *   file, You can obtain one at https://mozilla.org/MPL/2.0/.
 */
...
func (client *PDNSClient) newRequest(method string, endpoint string, body []byte) (*http.Request, error) {
...
// Returns name and type of record or record set based on its IDƒ
...
func (client *PDNSClient) detectAPIVersion() (int, error) {
...
func (client *PDNSClient) setServerVersion() error {
